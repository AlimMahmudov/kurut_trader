  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center bg-black overflow-hidden">
      ...
      <div className="relative z-30 text-center px-4">
        {/* Заголовок с использованием AOS */}
        <div data-aos="">
      ...
      {/* Свечи внизу (для цикличной анимации AOS не подходит, используем чистый CSS) */}
      ...
      {/* Стили для имитации бесконечной анимации свечей, так как AOS работает только один раз при скролле */}
      <style jsx>{`
        @keyframes pulse-h {
          0%,
          100% {
